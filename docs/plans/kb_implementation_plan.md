...
Файл общий для всех окружений (МКБ-10 коды не зависят от dev/prod/test). Начинаем с минимального словаря, расширяем по мере необходимости.

Поддерживаемые сценарии:
- **Синонимы** — несколько терминов на один код (разные названия одного состояния)
- **Мультиязычность** — русские и английские термины для одного кода (LLM может выдавать диагнозы на обоих языках)
- **Частые ошибки ввода** — опечатки и искажённые формы, которые встречаются в реальных документах
- **Один маппер, один поиск** — `ICD10Mapper.map_terms()` работает со всеми вариантами через case-insensitive lookup

```yaml
mappings:
  # Головная боль / мигрень
  "головная боль": "G44.0"
  "headache": "G44.0"        # английский синоним
  "мигрень": "G43"
  "migraine": "G43"          # английский синоним
  "mirain": "G43"            # частая ошибка ввода

  # Аллергия
  "аллергия": "T78.4"
  "allergy": "T78.4"         # английский синоним
  "аллергическая реакция": "T78.4"

  # Сердечно-сосудистые
  "гипертония": "I10"
  "hypertension": "I10"      # английский синоним
  "артериальная гипертензия": "I10"
  "ишемия": "I25.9"
  "ишемическая болезнь": "I25.9"
  "варикоз": "I83.9"
  "варикозное расширение вен": "I83.9"

  # Эндокринные
  "диабет": "E11"
  "сахарный диабет": "E11"
  "diabetes": "E11"           # английский синоним

  # Дыхательная система
  "бронхит": "J40"
  "bronchitis": "J40"         # английский синоним
  "пневмония": "J18.9"
  "pneumonia": "J18.9"        # английский синоним
...
**Принцип расширения словаря:** добавлять новый термин на одну строку, указывая комментарием причину (синоним / язык / ошибка). Один термин → один код. Несколько терминов могут маппиться на один код.
